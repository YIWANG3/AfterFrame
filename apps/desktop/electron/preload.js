...
contextBridge.exposeInMainWorld("mediaWorkspace", {
  ...
  pauseJob: (jobId) => ipcRenderer.invoke("workspace:pause-job", jobId),
  ...
  getAssetLocation: (assetId) => ipcRenderer.invoke("workspace:get-asset-location", assetId),
  clearAiLocation: (assetId) => ipcRenderer.invoke("workspace:clear-ai-location", assetId),
  ...
  getTextImageStatus: () => ipcRenderer.invoke("workspace:text-image-status"),
  startTextImage: (options) => ipcRenderer.invoke("workspace:text-image-start", options),
  pickHandwritingRef: () => ipcRenderer.invoke("workspace:pick-handwriting-ref"),
  getHandwritingPresetRef: (presetId) => ipcRenderer.invoke("workspace:handwriting-preset-ref", presetId),
  ...
  getPeopleSettings: () => ipcRenderer.invoke("workspace:get-people-settings"),
  setPeopleAutomaticDownloads: (enabled) => ipcRenderer.invoke("workspace:set-people-auto-download", enabled),
  pickPeopleModel: () => ipcRenderer.invoke("workspace:pick-people-model"),
  downloadOfficialPeopleModel: () => ipcRenderer.invoke("workspace:download-official-people-model"),
  setActivePeopleModel: (key) => ipcRenderer.invoke("workspace:set-active-people-model", key),
  removePeopleModel: (key) => ipcRenderer.invoke("workspace:remove-people-model", key),
  startPeopleIndex: (options) => ipcRenderer.invoke("workspace:people-index-start", options),
  getPeopleIndexStatus: () => ipcRenderer.invoke("workspace:people-index-status"),
  ...
  setPeopleGroupsState: (options) => ipcRenderer.invoke("workspace:set-people-groups-state", options),
  mergePeopleGroups: (options) => ipcRenderer.invoke("workspace:merge-people-groups", options),
  removeFaceFromPerson: (options) => ipcRenderer.invoke("workspace:remove-face-from-person", options),
  assignFaceToPerson: (options) => ipcRenderer.invoke("workspace:assign-face-to-person", options),
