...
export const IPC_METHODS = [
  ...
  ["getWatermarkProfile", "app:watermark-profile", 0],
  ["saveWatermarkProfile", "app:save-watermark-profile", 1],
  ["listFrameTemplates", "app:frame-templates", 0],
  ["saveFrameTemplates", "app:save-frame-templates", 1],
  ...
  ["getDevStaleness", "app:dev-staleness", 0],
  ["relaunchApp", "app:relaunch", 0],
